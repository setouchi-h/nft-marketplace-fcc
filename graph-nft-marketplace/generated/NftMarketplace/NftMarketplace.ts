...
export class NftMarketplace__getListedResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  getListed(
    nftAddress: Address,
    tokenId: BigInt
  ): NftMarketplace__getListedResultValue0Struct {
    let result = super.call(
      "getListed",
      "getListed(address,uint256):((uint256,address))",
      [
    ...
    return changetype<NftMarketplace__getListedResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListed(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<NftMarketplace__getListedResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<NftMarketplace__getListedResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
